                ...
                <div class="p-4 space-y-4">
                    <div class="grid grid-cols-1 md:grid-cols-5 gap-4">
                        ...
                        <div>
                            ...
                            <div class="text-xs text-gray-600"><?php echo htmlspecialchars(formacaoOuCargoComA($t['usuario_formacao'])); ?></div>
                            <?php endif; ?>
                            <div class="text-xs text-gray-500"><?php echo htmlspecialchars(formacaoOuCargoComA($t['usuario_cargo'] ?? '') ?: '-'); ?></div>
                        </div>
                        <div>
                            ...
                            <div class="text-xs text-gray-600"><?php echo htmlspecialchars(formacaoOuCargoComA($t['auxiliar_formacao'])); ?></div>
                            <?php endif; ?>
                            <div class="text-xs text-gray-500"><?php echo htmlspecialchars(formacaoOuCargoComA($t['auxiliar_cargo'] ?? '') ?: '-'); ?></div>
                            <?php else: ?>
